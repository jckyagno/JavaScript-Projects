...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        checkWinConditions();
        //This condition is for changed the active player.
        if (activePlayer === 'X') {
    ...
    function computersTurn() {
        //This boolean is needed for our loop.
        let success = false;
...
function checkWinConditions() {
    ...
    //O 0, 4, 8 condition.
    else if (arrayIncludes('0O', '4XO', '8O')) { drawWinLine(100, 100, 520, 520) }
...
//This function takeds a string parameter of the path you set earlier for
//placement sound('./media/place.mp3')
function audio(audioURL) {
    //We create a new audio object and we pass the pathj as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        //This moether moves us to a starting point in out line.
        c.moveTo(x1, y1);
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            //This is necessaryt for the 6, 4, 2 win conditions.
...
function resetGame() {
    //This fopr loop iterates through each HTML square element.
    for (let i = 0; i < 9; i++) {
